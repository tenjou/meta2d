...
class Text extends Sprite
{
	...
	updateMesh() 
	{
		const canvas = this._texture.canvas
	...
	set fontColor(fontColor) {
		if(this._fontColor === fontColor) { return }
	...
	set shadowOffsetX(offsetX) {
		if(this._shadowOffsetX === offsetX) { return }
		this._shadowOffsetX = offsetX
		this.needUpdateMesh = true
	}

	set shadowOffsetY(offsetY) {
		if(this._shadowOffsetY === offsetY) { return }

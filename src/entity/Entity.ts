...
export class Entity {
    _volume: AABB = new AABB()
    _transform: Matrix3 = new Matrix3()
    _position: Vector2 = new Vector2()
    _scale: Vector2 = new Vector2(1, 1)
    _size: Vector2 = new Vector2()
    _pivot: Vector2 = new Vector2()
    _anchor: Vector2 = null
    _rotation: number = 0
    _layer: number = 0

    parent: Entity = null
    children: Array<Entity> = null
    components: Array<Component> = null
    enabled: boolean = false
    removed: boolean = false
    _needUpdateTransform: boolean = false
    needUpdateVolume: boolean = true
    needUpdateFrame: boolean = true
    debug: boolean = false
    ...
    addComponent(componentCls: new () => Component){
